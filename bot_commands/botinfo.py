...
def register(bot):
    ...
    async def botinfo(interaction):
        ...
        embed = make_embed(
            ...
            "Moderasyon, AutoMod, sunucu koruma, ekonomi, ticket, cekilis, kayit, muzik, voice welcome, welcome karti, buton rol ve full log sistemi aktif.",
            0x8B5CF6
        )
        ...
        embed.add_field(name=f"{emoji('shield')} Log Paketi", value="Mesaj, uye, AutoMod, koruma, kayit, muzik, voice welcome, rol, kanal, ses, ban, emoji", inline=False)
