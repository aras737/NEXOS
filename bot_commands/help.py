...
COMMAND_LINES = [
    ...
    "`/automod-settings` davet/link/spam/etiket AutoMod ayarlarini yapar.",
    "`/automod-word-add` yasak kelime ekler.",
    "`/automod-word-remove` yasak kelime siler.",
    "`/automod-info` AutoMod ayarlarini gosterir.",
    "`/security-settings` bot ekleme korumasi ve anti-raid ayarlarini yapar.",
    "`/security-allow-bot` izinli bot listesine bot ID ekler.",
    "`/security-deny-bot` izinli bot listesinden bot ID siler.",
    "`/security-info` sunucu koruma ayarlarini gosterir.",
    "`/register-settings` Isim | Yas kayit kanalini ve yas rol sistemini ayarlar.",
    "`/register-panel` kayit format panelini gonderir.",
    ...
    "`/giveaway-start` butonlu cekilis baslatir.",
    "`/giveaway-end` aktif cekilisi bitirir.",
    "`/giveaway-reroll` bitmis cekilis icin yeni kazanan secer.",
    "`/giveaway-cancel` aktif cekilisi iptal eder.",
    "`/giveaway-list` aktif cekilisleri listeler.",
    "`/music-play` yonetici olarak ses kanalinda muzik acar.",
    "`/music-skip` calan muzigi atlar.",
